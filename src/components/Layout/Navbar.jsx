...
const NavBar = (props) => {
    ...
    const renderMobileMenu = (
        ...
        >
            <MenuItem>
                <IconButton aria-label="Manager projektu" color="inherit">
            ...
            <MenuItem>
                <IconButton aria-label="Raporty pracowników" color="inherit">
                    <Badge  color="secondary">
                        <NotificationsIcon />
                    </Badge>
                </IconButton>
            ...
            <MenuItem >
                <IconButton aria-label="Zgłoszenia" color="inherit">
                    <Badge color="secondary">
                        <MailIcon />
                    </Badge>
                </IconButton>
    ...
    return (
        <div>
            <AppBar position={props.position} className={props.className} color="default">
                <Toolbar>
                    <IconButton
                        edge="start"
            ...
            {props.user ? renderMobileMenu : null}
            {props.user ? renderMenu : null}
        </div>
    );
};
